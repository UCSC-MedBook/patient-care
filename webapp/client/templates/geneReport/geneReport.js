 ...
 */
function chrisCodeHere(geneReport, patientSamples, expressionData, viperSignaturesData, targettingDrugsData) {
...
Template.renderCircleMap.rendered = function() {
    Deps.autorun(function(first) {
        if (Session.get("geneReportLoaded") === true) {
            ...
            chrisCodeHere(geneReport, patientSamples, expressionData, viperSignaturesData, targettingDrugsData);
            first.stop();
        }
    });
};
